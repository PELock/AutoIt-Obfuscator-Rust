# AutoIt Obfuscator — Obfuscation for AutoIt Script Source Code (Rust crate)
...
## Protect your AutoIt scripts source code (Rust)
...
The preferred way to install the Web API SDK is via crates.io / Cargo.

```bash
cargo add autoit-obfuscator
```

Or add `autoit-obfuscator = "1"` to `[dependencies]` in `Cargo.toml`.

## Usage examples

### Example — `autoit-obfuscator-example-is-demo.rs`
...
### Example — `autoit-obfuscator-example-simple.rs`
...
### Example — `autoit-obfuscator-example.rs`
